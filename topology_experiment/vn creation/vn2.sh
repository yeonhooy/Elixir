...
python $OVXCTL -n createNetwork tcp:20.1.0.3:10001 172.0.0.0 16
TENENT="2"

#switch
python $OVXCTL -n createSwitch $TENENT 10:00:00:00:00:00:00:01 #s1001 00:a4:23:05:00:00:00:01
python $OVXCTL -n createSwitch $TENENT 10:00:00:00:00:00:00:04 #s1004 00:a4:23:05:00:00:00:02
...
#Port
python $OVXCTL -n createPort $TENENT 10:00:00:00:00:00:00:01 1 #s1002 p1
python $OVXCTL -n createPort $TENENT 10:00:00:00:00:00:00:01 4 #s1004 p4
...
python $OVXCTL -n createPort $TENENT 20:00:00:00:00:00:00:07 1 #s2007 p2
...
python $OVXCTL -n createPort $TENENT 30:00:00:00:00:00:00:02 3 #s3002 p3 (host3)
...
python $OVXCTL -n createPort $TENENT 30:00:00:00:00:00:00:08 3 #s3008 p3 (host15)
